...
public class RunCommunicateWithServers {
    public static void main(String[] args) {
        ...
        Configurations.setMazeGenerator("My Maze Generator");
        Configurations.setSearchingAlgorithm("Best First Search");
            ...
            Client client = new Client(InetAddress.getLocalHost(), 5401, new IClientStrategy() {
                        public void clientStrategy(InputStream inFromServer, OutputStream outToServer) {
                            try {
                                ...
                                toServer.flush();
                                Solution mazeSolution = (Solution) fromServer.readObject(); //read generated maze (compressed with MyCompressor) from server//Print Maze Solution retrieved from the server
